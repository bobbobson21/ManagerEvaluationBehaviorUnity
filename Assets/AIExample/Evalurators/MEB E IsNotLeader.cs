...
#if UNITY_EDITOR
[InitializeOnLoad]
public class UserManger_Eval_IsNotLeader_UI : MEB_UI_BehaviourEditor_ManagerData
{
    static UserManger_Eval_IsNotLeader_UI()
    {
        MEB_UI_BehaviourEditor.AddEvalManager(new UserManger_Eval_IsNotLeader_UI());
    }

    public UserManger_Eval_IsNotLeader_UI()
    {
        m_name = "UserManger_Eval_IsNotLeader";
    }
...
public class UserManger_Eval_IsNotLeader : MEB_BaseManager, MEB_I_EvalScoop
{
