...
public class MEB_CreateManagerEval
{
    [MenuItem("Assets/Create/MEB/create evaluation manager script", priority = 4)]
    public static void CreateManager()
    {
        string pathOfNewFile = AssetDatabase.GetAssetPath(Selection.activeObject); //finds out where to put the new blackboard
        string nameOfNewFile = "MEB EvalManagerScript";
        ...
        string exportPath = "Assets/MEBS/Edit/Menus/ExampleManagerEvalContainer.txt";
