...
public class MEB_CreateBlackBoard
{
    [MenuItem("Assets/Create/MEB/create blackboard script", priority = 4)]
    public static void CreateBoard()
    {
        string pathOfNewFile = AssetDatabase.GetAssetPath(Selection.activeObject); //finds out where to put the new blackboard
        string nameOfNewFile = "MEB BlackboardScript";
        ...
        string exportPath = "Assets/MEBS/Edit/Menus/ExampleBlackboardContainer.txt";
